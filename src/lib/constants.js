...
export const sampleRecipes = [
    {
        ...
        instructions: [
            { id: 1, instruction: "Soak the mung beans in ½ quart water overnight. 14 ounces mung beans, 1 ½ quarts water" },
            { id: 2, instruction: "Heat 3 tablespoons of cooking oil in a deep cooking pot." },
            { id: 3, instruction: "Sauté the garlic until it starts to brown. Add the onion and tomato. Continue sautéing until softened." },
