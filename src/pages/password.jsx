    ...
    return (
        <Form ref={formRef} className="form-floating p-3 p-md-0" method="POST">
            <div className="form-floating w-100">
                <input type="password" required className="form-control bg-light mb-3" id="oldPassword" name="oldPassword" placeholder="********" />
                <label htmlFor="oldPassword">Old password</label>
            </div>

            <div className="form-floating w-100">
                <input type="password" required className="form-control bg-light mb-3" id="newPassword" name="password" placeholder="********" />
