...
function Me() {
    ...
    return (
        <div className="d-md-none px-3">
            <Submenu clickHandler={() => openSlide({ open: true, header: SUBMENU_HEADERS[0] })} text={SUBMENU_HEADERS[0]} />
            <Submenu clickHandler={() => openSlide({ open: true, header: SUBMENU_HEADERS[1] })} text={SUBMENU_HEADERS[1]} />
        </div>
    );
}
